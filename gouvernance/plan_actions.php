...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['ajouter_action']) && $budget_id) {
                ...
                <div class="table-responsive">
                    <table class="table table-hover align-middle mb-0">
                        <thead class="table-light small text-uppercase font-monospace text-secondary">
                            <tr>
                                <th style="width: 20%;" class="ps-3">Objectif</th>
                                <th style="width: 40%;">Activités & Thèmes</th>
                        ...
                        <tbody>
                            <?php if(empty($actions)): ?>
                                <tr>
                                    <td colspan="4" class="text-center py-5 text-muted small">Aucune activité enregistrée pour le moment.</td>
                                </tr>
                            <?php else: ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-top pt-3">
                                            ...
                                            <div class="text-muted small mt-1">
                                                <i class="fa-solid fa-wallet me-1"></i><?= number_format($act['budget_estime'], 0, ',', ' ') ?> €
                                            </div>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
